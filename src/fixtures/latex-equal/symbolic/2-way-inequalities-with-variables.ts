export default {
  ...
  tests: [
    ...
    },
    {
      ...
      eq: ["8*(-\\frac{3}{4}m-\\frac{1}{8}) ≤ - \\frac{1}{4} * 8", "8(-\\frac{3}{4}m)-8(\\frac{1}{8})≤ 8(-\\frac{1}{4})", "-6m-1≤-2", "-6m-1+1≤-2+1", "m ≥ \\frac{1}{6}"],
      ne: ["8(-\\frac{5}{4}m)-8(\\frac{1}{8})≤ 8(-\\frac{1}{4})", "8(-\\frac{3}{4}m)-8(\\frac{2}{8})≤ 8(-\\frac{1}{4})"]
    },
  ],
};
