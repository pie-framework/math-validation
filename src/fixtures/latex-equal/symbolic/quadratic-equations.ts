...
//only: true,
  ...
  tests: [
    ...
    {
      target: "6x^2+4x+2=0",
      eq: ["3x^2+2x+1=-1", "x^2+\\frac{2x}{3}+\\frac{2}{3}=0"],
      ne: ["x^2+\\frac{2x}{3}+\\frac{2}{4}=0", "x^2+\\frac{2x}{3}+\\frac{2}{5}=0", "x^2+\\frac{2x}{3}+\\frac{2}{6}=0"]
    },
    {
      target: "3x^2-18x+14=0",
      eq: ["3(x^2-6x)+14=0", "3(x^2-6x +3^2-3^2)=-14", "3(x^2-6x+3^2)-3(9)+14=0", "3(x-3)^2-13=0"],
    },
    {
      target: "(t-5)^2-9=0",
      eq: ["(t-5)^2=9"],
    ...
    },
    {
      ...
      eq: ["\\frac{6}{(x+1)(x+1)}+\\frac{5}{5(x+1)}=1", "\\frac{6}{x(x+1)+1(x+1)}+\\frac{5}{5(x+1)}=1", "\\frac{6}{x^2+x+1(x+1)}+\\frac{5}{5(x+1)}=1"],
